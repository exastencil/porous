  ...
  render :html do
      ...
      div class: 'flex items-center w-full lg:w-1/2' do
        div class: 'max-w-2xl mb-8' do
          ...
          p class: 'py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300' do
            "Nextly is a free landing page & marketing website template for startups and indie projects. It's built with Next.js & TailwindCSS. And its completely open-source."
          end

          div class: 'flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row' do
            a href: 'https://web3templates.com/templates/nextly-landing-page-template-for-startups', target: '_blank',
              rel: 'noopener', class: 'px-8 py-4 text-lg font-medium text-center text-white bg-indigo-600 rounded-md' do
              'Download for Free'
            end
            a href: 'https://github.com/web3templates/nextly-template/', target: '_blank', rel: 'noopener',
    ...
    div class: 'container p-8 mx-auto xl:px-0' do
      div class: 'flex flex-col justify-center' do
        div class: 'text-xl text-center text-gray-700 dark:text-white' do
          text 'Trusted by '
          span(class: 'text-indigo-600') { '2000+' }
