class VerizonLogo < Porous::Component
  render :html do
    svg xmlns: 'http://www.w3.org/2000/svg', width: 138, height: 31, viewBox: '0 0 658 146' do
      g fill: 'currentColor', fillRule: 'evenodd', stroke: 'none', strokeWidth: 1 do
        path d: 'M642.7 0L606.8 76.8 593.3 47.7 578.7 47.7 600.9 95.3 612.7 95.3 657.2 0z'
